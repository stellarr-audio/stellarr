...
import type { UpdateStatePayload } from '../bridge/updateTypes';
...
interface StellarrState {
  ...
  // Floating MIDI panel — open/closed state is NOT persisted (ephemeral
  // session UI). Panel position IS persisted — see useUiPrefsStore.
